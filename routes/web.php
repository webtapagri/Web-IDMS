...
Route::group(['middleware' => [ 'auth' ]], function () {
	...
	Route::group(['prefix'=>'report'], function () {
		...
		Route::get('/summary-data/{werks}/{year}', 	'ReportsController@summary_data')->name('report.summary_data');
		// Route::get('/print_pdf/{dt}', 	'ReportsController@print_pdf')->name('report.print_pdf');
		// Route::get('/summary-data-year/{werks}/{year}', 	'ReportsController@summary_data_year')->name('report.summary_data_year');
	});
